...
register_nav_menus(
	array(
		...
		'org-nav' => __( 'Organization Menu', 'jointstheme'), //The organization menu
		'vol-nav' => __( 'Volunteer Menu', 'jointstheme') // The volunteer menu
	)
);
...
// Organization Menu
function joints_org_nav() {
	 wp_nav_menu(array(
        'container' => false,                           // Remove nav container
        'container_class' => '',                        // Class of container
        'menu' => 'The Org Menu', 'jointstheme',                                   // Menu name
        'menu_class' => 'top-bar-menu right',            // Adding custom nav class
        'theme_location' => 'org-nav',                // Where it's located in the theme
        'before' => '',                                 // Before each link <a>
        'after' => '',                                  // After each link </a>
        'link_before' => '',                            // Before each link text
        'link_after' => '',                             // After each link text
...
// Volunteer Menu
function joints_vol_nav() {
	 wp_nav_menu(array(
        'container' => false,                           // Remove nav container
        'container_class' => '',                        // Class of container
        'menu' => 'The Org Menu', 'jointstheme',                                   // Menu name
        'menu_class' => 'top-bar-menu right',            // Adding custom nav class
        'theme_location' => 'vol-nav',                // Where it's located in the theme
        'before' => '',                                 // Before each link <a>
        'after' => '',                                  // After each link </a>
        'link_before' => '',                            // Before each link text
        'link_after' => '',                             // After each link text
